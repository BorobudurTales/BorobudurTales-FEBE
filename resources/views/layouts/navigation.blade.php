        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('home') }}">
                        <img src="/img/logo.png" class="h-8 w-auto" alt="Logo" />
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    @php
                        $navItems = [
                            ...
                            ['name' => 'Library A', 'route' => 'library-a'],
                        ];
                    @endphp

                    @foreach ($navItems as $item)
                        <a href="{{ route($item['route']) }}"
                           class="text-sm font-medium {{ request()->routeIs($item['route']) ? 'text-white' : 'text-black' }} hover:underline">
                            {{ $item['name'] }}
                        </a>
                    @endforeach
                </div>
