<footer class="w-full bg-[#343434] text-[#D9D9D9] border-t-2" style="border-image: linear-gradient(45deg, #D6AD60, #949494) 1;">
  <div class="max-w-[1280px] mx-auto px-6 pt-12 pb-5">
    <div class="flex flex-col items-start justify-between gap-1 md:flex-row">
      <!-- Logo + Info -->
      <div class="flex items-start">
        <div>
          <div class="text-[26px] gap-3 flex font-bold font-['Protest_Strike'] opacity-70 leading-tight mb-4">
          ...
          <p class="text-lg font-['Inria_Serif'] opacity-70 leading-[1.6] max-w-[400px]">
    ...
    <!-- Garis + Copyright -->
    <div class="border-t border-[#FFFDFD]/40 mt-10 pt-5 text-center text-xs text-[#D9D9D9] opacity-60 font-['Inter']">
